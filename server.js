// ─────────────────────────────────────────────────────────────────────────────
// Optional Node.js proxy that extracts native .m3u8 stream URLs from
// VidSrc embed pages using Playwright (headless Chromium).
//
// Deploy to: Railway, Render, Fly.io, or any Node host.
// Flutter calls: GET /sources?imdb=tt1375666
// or: GET /sources?imdb=tt0903747&season=1&episode=1
// ─────────────────────────────────────────────────────────────────────────────
